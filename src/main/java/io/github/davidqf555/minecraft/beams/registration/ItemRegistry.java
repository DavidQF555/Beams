...
public final class ItemRegistry {
    ...
    public static final RegistryObject<TargetingModuleItem> MONSTER_TARGETING_MODULE = register("monster_targeting_module", getTab(), () -> new TargetingModuleItem(new EntityTargetingType(entity -> entity.getClassification(false) == MobCategory.MONSTER), new Item.Properties()));
    public static final RegistryObject<TargetingModuleItem> CREATURE_TARGETING_MODULE = register("creature_targeting_module", getTab(), () -> new TargetingModuleItem(new EntityTargetingType(entity -> entity.getClassification(false) == MobCategory.CREATURE), new Item.Properties()));
    public static final RegistryObject<TargetingModuleItem> PLAYER_TARGETING_MODULE = register("player_targeting_module", getTab(), () -> new TargetingModuleItem(new EntityTargetingType(entity -> entity instanceof Player), new Item.Properties()));
