...
public class EntityTypeTargetingModuleItem extends TargetingModuleItem {
    ...
    private final static Component BLACKLIST = new TranslatableComponent("item." + Beams.ID + ".entity_type_targeting_module.blacklist").withStyle(ChatFormatting.GREEN),
            WHITELIST = new TranslatableComponent("item." + Beams.ID + ".entity_type_targeting_module.whitelist").withStyle(ChatFormatting.RED),
            INSTRUCTIONS = new TranslatableComponent("item." + Beams.ID + ".entity_type_targeting_module.instructions").withStyle(ChatFormatting.ITALIC).withStyle(ChatFormatting.DARK_PURPLE);
