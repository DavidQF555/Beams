...
public final class BlockRegistry {
    ...
    public static final RegistryObject<MirrorBlock> MIRROR = register("mirror", () -> new MirrorBlock(AbstractBlock.Properties.of(Material.METAL, MaterialColor.GOLD).requiresCorrectToolForDrops().strength(3, 6).sound(SoundType.METAL)));
