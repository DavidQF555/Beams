...
public final class BlockRegistry {
    ...
    public static final RegistryObject<SimpleMirrorBlock> MIRROR = register("mirror", () -> new SimpleMirrorBlock(BlockBehaviour.Properties.of(Material.METAL).strength(3.5f)));
